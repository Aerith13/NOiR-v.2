...
// Example usage:
document.getElementById("tab-chaz").addEventListener("click", function() {
    openChatApp("https://wyre-nft-marketplace.vercel.app/");
});
